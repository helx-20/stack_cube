...
if __name__ == "__main__":
    ...
    # === get cube actor for StackCube ===
    base_env = envs._env.unwrapped  # 这里一般就是 StackCubeEnv
    cube_actor = base_env.cubeA     # StackCube 的红色被操纵方块（Actor）
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        if iteration % args.eval_freq == 1:
            ...
            eval_cube_actor = eval_base_env.cubeA  # StackCube
            num_episodes = 0
                ...
                with torch.no_grad():
                    with torch.no_grad():
                        ...
                        if args.disturb_force_mag > 0:
                            ...
                            # StackCube: 3D 离散采样，每个分量 ∈ {-1.0, -0.8, ..., 0.8, 1.0}
