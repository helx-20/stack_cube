...
if __name__ == '__main__':
    ...
    # parser.add_argument('--criticality_ckpt', type=str, default='criticality/stage2/model/stage2_dqn_iter4600.pt')
    ...
    parser.add_argument('--criticality_threshold', type=float, default=0.3, help="Threshold for applying disturbance in NADE")
